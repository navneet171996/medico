...
const Navbar_Admin = () => {
  ...
  <div className="flex flex-row items-center justify-start gap-[0px_13px]">
    ...
    />
    <Link to="/patient_History" className="relative font-semibold z-[1] no-underline text-black">Approvals</Link>
    
  </div>
  <div className="flex flex-row  items-center justify-start gap-[0px_13px]">
    
    <Link onClick={logout} to="/patient_History" className="relative left-3 font-semibold z-[1] no-underline text-black ">Logout</Link>
